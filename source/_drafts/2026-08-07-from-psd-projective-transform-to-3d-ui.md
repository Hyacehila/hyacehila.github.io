---
title: "从 PSD 四点透视到经典 3D UI：TA 需要研究的技术路线"
date: 2026-08-07 18:00:00 +0800
categories: ["Creative Media & Games", "Game AI & Production"]
tags: ["Technical Art", "UI", "PSD", "3D"]
author: Hyacehila
excerpt: "四角透视卡片不是一个 rotation 数值，而是投影到任意四边形的平面；本文梳理 TA 从 PSD 设计稿到经典 3D UI 的变换分类、引擎能力、拟合和可靠降级路线。"
---
