...
这篇文章中的问题也可以和[生成式 AI 之前，游戏 NPC 是怎样成为 Agent 的](/blog/2026/06/20/game-npc-agents-before-llm/)、[多模态 Agent AI 综述：范式、学习机制与应用](/blog/2025/01/15/agent-ai-multimodal-survey/)放在一起阅读，以比较相近的概念如何在不同语境中展开。
...
游戏类型不是那种能一次放准的文件夹。它更像聊天时用的速记。说“Roguelike”，别人会想到随机、死亡、重复尝试；说“MOBA”，别人会想到英雄、兵线、团队配合；说“休闲”，别人会先假设它容易上手、压力不大、适合短时间打开。

这些词不一定严谨，但很有用。问题是，只把它们当标签贴上去，很容易偷懒。一个“RPG”到底是在说角色成长，还是在说剧情选择？一个“开放世界”是在说地图大，还是在说玩家真的能自由组织目标？一个“抽卡养成”是在说玩法，还是在说长期运营和商业结构？

所以这篇文章做的事很简单：把这些类型名拆开看一遍。哪些是传统大类，哪些是融合类型，哪些其实在描述平台、情绪、社交方式或商业模式。它不算词典，更像一份学习笔记。以后再说一款游戏是什么类型时，至少能知道自己到底在强调哪一层。
...
一款游戏可以同时属于很多类型。这不叫分类失败，电子游戏本来就长这样。说出一个类型名时，知道自己在强调什么，也知道它没说完什么，就够了。
