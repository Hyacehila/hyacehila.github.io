...
这篇文章中的问题也可以和[点集拓扑学：拓扑空间、连续性与子空间](/blog/2024/10/16/point-set-topology-notes/)、[微分几何：几何学分类、曲线论与曲面论](/blog/2025/02/04/differential-geometry-notes/)放在一起阅读，以比较相近的概念如何在不同语境中展开。
