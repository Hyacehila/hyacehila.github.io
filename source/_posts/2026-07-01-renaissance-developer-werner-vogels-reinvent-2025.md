...
这不是一场隆重的告别，更像 Werner 把麦克风放下，说：这部分我讲完了。
...
Werner 没有顺着 AI 热点讲当时最热的概念。他讲的很多东西，还是软件工程里的老问题，只是换到了 AI Coding 的场景里。

AI 会不会抢走开发者的工作，Vibe Coding 会不会把写软件变成自然语言魔法，Spec-driven development 是不是新的工程范式，这些都可以讨论。可需求该怎么理解，风险该怎么判断，结果该怎么负责，AI 时代只是把这些问题推得更近了。

这场 talk 值得留一份笔记，也顺便拯救一下我目前鱼一样的记忆。

## 为什么是文艺复兴开发者

Werner Vogels 是 Amazon 的 CTO，也是 AWS 技术文化里很醒目的一个人。在加入 Amazon 之前，他曾在 Cornell 做分布式系统研究；加入 Amazon 之后，他长期围绕云计算、分布式系统、机器学习展开研究。

如果只从产品发布看 Werner，他是 AWS 历史上很醒目的技术代言人，很多重要产品和理念都由他发布。也可以把他看成一种工程气质的代表：不太沉迷技术本身有多炫，更多时候在追问系统会怎么失败、怎么变简单，以及客户实际会遇到什么。

文艺复兴开发者这个说法也在这里变得有意思。

文艺复兴不只靠某个工具突然出现，印刷术、显微镜、透视法、新的航海技术都在场。在那段历史里是一批人开始跨过学科边界，把科学、艺术、工程、商业和社会放在一起。

今天的开发者多少也站在类似的位置。AI、云计算、具身智能、生物工程、空间技术、能源系统正在彼此耦合。软件工程不再只是屏幕上的应用，它越来越多地进入医疗、物流、教育、能源和公共治理，也因此带来了新的风险。
...
对事情保持好奇，继续追问模型为什么这么写、它省略了什么、它有没有把某个旧 API 当成了新写法。理解不是附带产物，得自己去拿。
...
对 AI Agent 来说，系统性思维更重要，任何 Agent 都是系统。单个模型能力当然要看，但系统是否可靠，常常取决于上下文供给、工具权限、状态管理、验证机制、失败恢复和人类审查怎么配合。问完模型能不能做，还得继续看它犯错时系统会怎样退化。
...
在 AI 编程时代，沟通能力被放大了。不只是人与人之间，还有人与 AI 的沟通，以及 AI 带来的人与人之间的新沟通。
...
联合国《World Population Prospects 2024》显示，全球人口在 2024 年约为 82 亿，预计会在本世纪中后期继续增长，并在 2080 年代中期达到约 103 亿的峰值。人口预测会随着数据更新而变化，但未来几十年，医疗、能源、教育、基础设施、气候适应和经济机会都会面对持续压力。

这些压力最后都会落到具体技术问题上：更可靠的医疗数据系统，更低成本的清洁能源分发，更容易使用的高级计算能力，以及不只服务注意力经济的 AI 应用。

AI 会继续变强，开发工具也会继续变化。Werner 留下的那几条老原则，大概还会继续有用。
