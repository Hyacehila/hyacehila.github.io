...
这篇文章中的问题也可以和[在代码逐渐廉价之后](/blog/2026/07/08/after-code-is-cheap/)、[我们又回到了 CLI：Agent 时代 CLI 与 GUI](/blog/2026/05/27/cli-vs-gui-agent-era/)放在一起阅读，以比较相近的概念如何在不同语境中展开。
