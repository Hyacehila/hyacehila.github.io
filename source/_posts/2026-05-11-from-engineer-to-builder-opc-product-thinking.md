...
tags: ["Builder Mindset", "Product Thinking", "Software Engineering", "AI Product"]
author: Hyacehila
excerpt: "生成式 AI 降低了代码、设计草稿和资料整理的成本，也让个人能够更快试做产品。工程师接下来需要学习选择问题、接触用户、验证付费意愿并找到稳定的分发入口。"
...
- Anthropic, [The Anthropic Economic Index](https://www.anthropic.com/news/the-anthropic-economic-index?pubDate=20250519)
...
- Fortune, [Could AI create a one-person unicorn?](https://fortune.com/2024/02/04/sam-altman-one-person-unicorn-silicon-valley-founder-myth/)
...
- Blake Masters / Peter Thiel, [CS183 notes: If You Build It, Will They Come?](https://github.com/startup-engineering/000-how-to-build-the-future/blob/main/09-if-you-build-it.md)
