...
这篇文章中的问题也可以和[正在取代前端工程师的 AI，做不出游戏里最简单的一块面板](/blog/2026/08/08/ui-pipeline-automation-thinking/)、[游戏行业如何引入 AI Agent](/blog/2026/05/05/ai-agent-game-industry-pipeline/)放在一起阅读，以比较相近的概念如何在不同语境中展开。
...
第三层可以叫作 AI World。这里强调的仍然是世界，但重点不再是 NPC 对世界的感知与影响，而是世界本身。判断一项尝试是否接近这一层，我会看模型有没有进入世界状态的更新链路，而不只是给 NPC 生成更自然的对话。玩家做出选择后，资源、关系、制度和人物决策继续变化，叙事与玩法自由，故事自然涌现。到了这一层，世界演化本身就是玩法。

[斯坦福 Smallville（Generative Agents）](https://arxiv.org/abs/2304.03442)用 25 个 Agent 的记忆、反思和计划，让日常互动累积成聚会、关系与社会事件；[港科大 Aivilization（智能体世界）](https://hkust.edu.hk/zh-hans/news/hkust-launches-worlds-largest-ai-powered-educational-sandbox-game-advancing-ai-literacy-and)把类似思路扩展到大规模社会模拟，让 Agent 参与生产、交易、社交，并逐渐形成治理结构与文化规范；[《历史模拟器：崇祯》](https://store.steampowered.com/app/4304230/)则把世界演化做进已经发行的历史策略游戏，玩家可以用自然语言下诏，模型在运行时生成世界状态反馈和大臣对话，让财政、军事与朝局沿着这些选择继续推演。[《西部世界》](https://press.wbd.com/us/property/westworld/synopses)仍是科幻中的参照系：如果角色拥有记忆、自主行动和彼此牵连的历史，一个主题乐园会不会逐渐变成不再围绕游客运转的世界？

这些例子处在不同的成熟度：一个是科幻想象中的参照，两个更接近研究与社会实验，一个已经成为面向玩家发行的商业游戏。Voyage 和 AI Dungeon 则是同一方向在文字冒险中的低引擎成本版本。在这里，AI 开始参与决定世界下一步会发生什么，而不只是负责 NPC 的下一句台词。玩家能在这样的世界里经历一段没有被策划提前写完的人生，这也是 Role-Playing Game 最吸引我的地方。
...
p.s. 如果考虑让 AI 进入游戏研发与运营的语境而非玩法，我在另一篇之前的 Blog 中聊过这个问题。AI 可以协助渲染、数值平衡和海量代码任务。但如果要让 AI 介入美术/动画等偏向艺术创作的内容，去让 AI 直接生产面向游戏内或社区中玩家的内容，那么请记住：AI没有灵魂，它无法理解上下文。作品的世界观、上下文与审美判断仍旧是人类需要去把持的，AI 能够生成内容，但不会天然理解这些。

## ICML 2026 AI4Game 、GDC 2026 、China Joy 2026
