...
到这里，Reward 这组三篇就串起了一条线：先看信号怎样被消费，再看信号怎样被生产，最后看信号在强优化下怎样失配。后续再进入 [training loop](/blog/2026/03/22/reward-and-training-in-agent-k-paperbench-amap/)：当 reward 已经被拆成 verifier、judge、rubric、trajectory ranking 和 hard constraints 以后，SFT、offline shaping、online RL、curriculum 和 distillation 需要怎样接起来。
