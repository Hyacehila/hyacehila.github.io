...
这篇文章中的问题也可以和[查找与排序算法：二分查找、散列表与排序实现](/blog/2024/12/18/search-and-sorting-algorithms/)、[数据库系统概念：数据模型、事务与查询处理](/blog/2024/12/23/database-systems-concepts/)放在一起阅读，以比较相近的概念如何在不同语境中展开。
