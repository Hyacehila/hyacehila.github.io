...
这篇文章中的问题也可以和[表格数据上仍旧是SOTA：XGBoost、LightGBM 与 CatBoost](/blog/2026/01/22/tree-based-models-tabular-data/)、[机器学习导论：监督学习与贝叶斯方法](/blog/2024/03/28/machine-learning-introduction-supervised-learning/)放在一起阅读，以比较相近的概念如何在不同语境中展开。
