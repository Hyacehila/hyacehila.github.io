...
tags: ["Model Routing", "Compound AI Systems", "Cost Engineering", "Latency", "Backend Engineering", "Inference Control"]
author: Hyacehila
...
我不建议一上来就训练一个 router。大多数项目更需要先看清自己的 Agent 调用链路，再设置几条简单规则；这一步通常已经能解决最明显的浪费和失败升级问题。
