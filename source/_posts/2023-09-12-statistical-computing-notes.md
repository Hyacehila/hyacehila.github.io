...
tags: ["Statistics", "Statistical Computing", "Simulation"]
author: Hyacehila
...
这篇文章中的问题也可以和[线性回归基础：线性模型、最小二乘估计与回归诊断](/blog/2023/09/04/linear-regression-basics-notes/)、[统计决策：决策问题、风险型决策与不确定型决策](/blog/2024/01/01/statistical-decision-theory-notes/)放在一起阅读，以比较相近的概念如何在不同语境中展开。
