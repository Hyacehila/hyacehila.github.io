...
这篇文章中的问题也可以和[初等概率论：随机事件、概率模型与随机变量](/blog/2023/03/18/elementary-probability-notes/)、[高等概率论：概率空间、随机变量与测度基础](/blog/2024/10/09/advanced-probability-notes/)放在一起阅读，以比较相近的概念如何在不同语境中展开。
