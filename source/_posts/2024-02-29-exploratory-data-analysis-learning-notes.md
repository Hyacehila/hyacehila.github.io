---
title: "探索性数据分析学习笔记"
title_en: "Exploratory Data Analysis Learning Notes"
...
author: Hyacehila
excerpt: "一篇探索性数据分析学习笔记，整理 EDA 的基本思想、描述性统计、数据可视化、数据预处理、数据清洗、数据融合、数据转换和 Box-Cox 变换。"
excerpt_en: "A study note on exploratory data analysis, covering EDA concepts, descriptive statistics, data visualization, preprocessing, cleaning, integration, transformation, and Box-Cox transforms."
mathjax: true
hidden: true
...
### EDA中都有什么内容
科学可视化是EDA中相当重要的一个部分 它隶属于统计图形的范畴 我们在 [R 统计可视化学习笔记](/blog/2024/03/15/r-visualization-learning-notes/) 中进行单独的介绍
...
### 数据可视化
除此以外 数据可视化技术也是EDA的重要一部分 [R 统计可视化学习笔记](/blog/2024/03/15/r-visualization-learning-notes/)
...
**我们提示过离散化要谨慎[R 统计可视化学习笔记中关于谨慎处理数据的讨论](/blog/2024/03/15/r-visualization-learning-notes/)，但此时我们必须离散化，保持警惕就好**
