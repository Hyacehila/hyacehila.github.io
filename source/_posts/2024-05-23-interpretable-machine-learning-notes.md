---
title: "可解释机器学习学习笔记"
title_en: "Interpretable Machine Learning Notes"
...
author: Hyacehila
excerpt: "一篇可解释机器学习学习笔记，整理可解释性概念、可解释模型、模型无关解释方法、SHAP、基于样本的解释、反事实解释和影响函数。"
excerpt_en: "A study note on interpretable machine learning, covering interpretability concepts, interpretable models, model-agnostic explanations, SHAP, example-based explanations, counterfactuals, and influence functions."
mathjax: true
hidden: true
