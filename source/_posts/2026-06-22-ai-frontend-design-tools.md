...
这篇文章中的问题也可以和[Spec 不是新范式：Vibe Coding、SDD 与 AI 时代的软件工程转向](/blog/2026/04/07/spec-is-not-the-new-paradigm/)、[我们又回到了 CLI：Agent 时代 CLI 与 GUI](/blog/2026/05/27/cli-vs-gui-agent-era/)放在一起阅读，以比较相近的概念如何在不同语境中展开。
