...
**本章将介绍 DPO（Direct Preference Optimization）**——一种让模型学习人类偏好的训练方法！为了能够更好地理解 DPO 的数学理论，建议参考原文 [https://arxiv.org/abs/2305.18290](https://arxiv.org/abs/2305.18290)；下面的数学原理不会非常完整，仅做简单介绍。
