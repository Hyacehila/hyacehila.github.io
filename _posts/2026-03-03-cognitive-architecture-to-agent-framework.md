...
![CoALA cognitive architecture]({{ site.baseurl }}/assets/images/agent-framework/coala-architecture.png)
...
![Agent Design]({{ site.baseurl }}/assets/images/agent-framework/agent-design.png)
