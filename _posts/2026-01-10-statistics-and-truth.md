...
直到20世纪初叶，人们才开始尝试将不确定性数量化，以回答这些问题。我们还不能说这个努力已经充分成功，但已取得的成果给人类活动的许多领域带来了一场革命。这场革命给予人类新的研究设想，促进了自然科学知识的发展，也改变了我们的思考方法。
...
但人们逐渐发现这并不可能。由于存在测量误差，人类很难准确了解系统的初始状态。在这种情形下，初始状态的微小差别可能导致对系统未来状态预报的极大差异。而将随机性引入自然科学领域同时出现了三个发展：
