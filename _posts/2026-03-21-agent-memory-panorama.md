...
这里先划清边界：本文讨论的是长期记忆如何形成、组织、更新、失效和评估；Working Memory 在本文中是长期记忆影响行动的运行时入口，而不是本文要展开的对象。当前推理现场如何选择、压缩、隔离和调度信息，是另一条独立的线，我放在[《Context is All You Need：智能体的上下文工程》](/blog/2026/03/23/agent-context-engineering/)里专门展开，本文不赘述。
