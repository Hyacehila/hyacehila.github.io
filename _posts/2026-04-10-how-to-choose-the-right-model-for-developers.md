...
> 2026年5月1日补：GPT-5.5 强的可怕快的飞起，Human 并行管理超多 Agent 的时代可能结束了，现在哪怕在使用 Codex 你也可以关注于更少的任务，更少在弱联系的项目中切换注意力，这意味着 Codex 不仅可以用于边界清晰后的长程任务完成，也可以更多的人类随时交互，但是他的对齐风格以及 Harness 风格没有明显的变化，他仍旧更倾向于完成一个任务边界清晰的任务，喜欢猜测任务边界而非更多的要求人类介入。 
...
> 注：Codex 已经开始给 Claude 提供插件了，从这个角度看本文的判断还是很有道理的嘛。让一个 Leader 给一个 Coder 派发任务并验收，两者没有高下之分，而是技术路线的的差异。
