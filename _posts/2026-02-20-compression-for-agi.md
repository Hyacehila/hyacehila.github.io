...
**主题：压缩即智能：为什么 ChatGPT 拥有智能？** 本文观点来自 OpenAI 核心研发人员 Jack Rae 的主题分享《Compression for AGI》。核心结论是：**AGI 基础模型的目标，是尽可能无损地压缩有效信息。**
...
从“压缩智能”的角度看，当前单一模态模型的目标是进一步扩展压缩比；而多模态模型的任务，则是寻找对复杂模态信息的压缩建模方法。BPE（Byte-Pair Encoding）可以处理文本的词表建模，基于统计频率的方法不仅高效，最终性能也相当客观，较大的缺点可能是对小众语言不友好；但音频与视频等模态仍需要更合适的离散化与表示。
